...
class SequenceParser extends CstParser {
    ...
    public name = this.RULE("name", (inConnection: boolean = false) => {
        this.OR([
            { 
                ALT: () => {
                    this.OPTION({
                        GATE: () => !inConnection || !this.isStandaloneDot(),
                        DEF: () => {
                            this.CONSUME(Dot, { LABEL: "leadingSep" });
                        }
                    });
                    ...
                    this.MANY({
                        ...
                        DEF: () => {
                            this.OR1([
                                { ALT: () => this.CONSUME(DoubleColon, { LABEL: "sep" }) },
                                { ALT: () => this.CONSUME1(Dot, { LABEL: "sep" }) }
                            ]);
    ...
    private isStandaloneDot(): boolean {
        ...
        while (true) {
            ...
            // If we find ANOTHER dot on the same line, this one is NOT standalone
        ...
        this.OR([
            ...
            { 
                ALT: () => {
                    this.CONSUME(LAngle);
                    this.MANY({
                        GATE: () => this.LA(1).tokenType !== RAngle && this.LA(1).tokenType !== EOF,
                        DEF: () => {
                            this.OR1([
    ...
    public multilineLabel = this.RULE("multilineLabel", () => {
        ...
        this.MANY({
            GATE: () => this.LA(1).tokenType !== RBracket,
            DEF: () => {
                this.OR([
                    { ALT: () => this.SUBRULE(this.anyToken) },
                    { ALT: () => this.CONSUME(Newline) }
    ...
    public anchor = this.RULE("anchor", () => {
        this.CONSUME(LBrace);
    ...
    public payload = this.RULE("payload", () => {
        ...
        this.MANY({
            GATE: () => {
                ...
                return nextType !== EndUml && nextType !== Newline;
            },
            DEF: () => {
                this.SUBRULE(this.anyToken);
            }
    ...
    public stereotype = this.RULE("stereotype", () => {
        ...
        this.MANY({
            GATE: () => {
                const next = this.LA(1).tokenType;
                return next !== RGuillemet && next !== Arrow && next !== Newline;
            },
    ...
    public shortFormDeclaration = this.RULE("shortFormDeclaration", () => {
        this.OR([
            ...
            },
            {
                ...
                ALT: () => {
                    this.CONSUME(LBracket);
                    this.SUBRULE1(this.name, { LABEL: "name" });
                    this.CONSUME(RBracket);
                }
            },
            {
                // (usecase)
                GATE: () => this.LA(1).tokenType === LParen && this.LA(2).tokenType !== RParen,
                ALT: () => {
                    this.CONSUME(LParen);
                    this.SUBRULE2(this.name, { LABEL: "name" });
                    this.CONSUME(RParen);
                }
            },
            {
        ...
        this.MANY(() => {
            this.OR1([
                { ALT: () => {
                    this.CONSUME(As);
                    this.SUBRULE4(this.name, { LABEL: "alias" });
                }},
                { ALT: () => this.SUBRULE(this.stereotype) },
                { ALT: () => this.SUBRULE(this.multilineLabel) },
    ...
    public participantDeclaration = this.RULE("participantDeclaration", () => {
        this.OR([
            ...
            { ALT: () => this.CONSUME(Control) },
            { ALT: () => this.CONSUME(Entity) },
            { ALT: () => this.CONSUME(Database) },
            { ALT: () => this.CONSUME(Collections) },
            { ALT: () => this.CONSUME(Queue) },
            { ALT: () => this.CONSUME(Artifact) },
            { ALT: () => this.CONSUME(Storage) },
            { ALT: () => this.CONSUME(Rectangle) },
            { ALT: () => this.CONSUME(Card) },
            { ALT: () => this.CONSUME(FileKeyword) },
            { ALT: () => this.CONSUME(Stack) },
            { ALT: () => this.CONSUME(Hexagon) },
            { ALT: () => this.CONSUME(Person) },
            { ALT: () => this.CONSUME(Process) },
            { ALT: () => this.CONSUME(Agent) },
            { ALT: () => this.CONSUME(LabelKeyword) },
            { ALT: () => {
                this.CONSUME(Usecase);
                this.OPTION2(() => this.CONSUME2(Slash));
            }},
            { ALT: () => this.CONSUME(Component) },
            { ALT: () => this.CONSUME(Action) },
            { ALT: () => this.CONSUME(Port) },
            { ALT: () => this.CONSUME(PortIn) },
            { ALT: () => this.CONSUME(PortOut) },
            ...
            { ALT: () => this.CONSUME(Metaclass) },
            { ALT: () => this.CONSUME(Protocol) },
            { ALT: () => this.CONSUME(Record) },
            { ALT: () => this.CONSUME(Dataclass) },
            { ALT: () => this.CONSUME(ObjectKeyword) },
            { ALT: () => this.CONSUME(MapKeyword) },
            { ALT: () => this.CONSUME(NodeKeyword) },
            { ALT: () => this.CONSUME(Cloud) },
            { ALT: () => this.CONSUME(Frame) },
            { ALT: () => this.CONSUME(Folder) },
    ...
    public memberLabel = this.RULE("memberLabel", () => {
        this.AT_LEAST_ONE({
            GATE: () => {
                const next = this.LA(1).tokenType;
                return next !== Newline && next !== RBrace && next !== EndUml;
            },
            DEF: () => this.SUBRULE(this.anyToken)
        });
    });

    public colorValue = this.RULE("colorValue", () => {
        this.OR([
            { ALT: () => this.CONSUME(Color) },
            { 
                ALT: () => {
                    this.CONSUME(Visibility);
    ...
    public classMember = this.RULE("classMember", () => {
        this.MANY(() => {
            this.OR([
                { ALT: () => this.CONSUME(Visibility) },
                { ALT: () => this.CONSUME(StaticModifier) },
                { ALT: () => this.CONSUME(AbstractModifier) },
                { ALT: () => this.CONSUME(FieldMarker) },
                { ALT: () => this.CONSUME(MethodMarker) }
            ]);
        });
        this.SUBRULE(this.memberLabel, { LABEL: "tokens" });
    });
    ...
    public parameter = this.RULE("parameter", () => {
        ...
        this.OPTION(() => {
            this.CONSUME(Colon);
            this.MANY(() => this.SUBRULE(this.anyToken, { LABEL: "typeTokens" }));
        });
    });
        ...
        this.OR([
                    ...
                    this.OR1([
                        ...
                        { 
                            ALT: () => {
                                ...
                                this.OPTION3(() => this.CONSUME1(Class));
                            }
                        },
                        { ALT: () => this.CONSUME(Circle) },
                        { ALT: () => this.CONSUME(Diamond) },
                            ...
                            },
                            {
                                ...
                                ALT: () => {
                                    this.OR4([
                                        ...
                                        { ALT: () => this.CONSUME(Implements) }
                                    ]);
                                    this.SUBRULE5(this.name, { LABEL: "parents" });
                                    this.MANY3(() => {
                                        this.CONSUME(Comma);
                                        this.SUBRULE6(this.name, { LABEL: "parents" });
                                    });
                                }
                            },
                            { ALT: () => this.SUBRULE(this.stereotype) },
                    ...
                    this.OR3([
                        {
                            ALT: () => {
                                this.CONSUME(LBrace);
                                this.MANY5({
                                    GATE: () => this.LA(1).tokenType !== RBrace && this.LA(1).tokenType !== EOF,
                                    DEF: () => {
                                        this.OR5([
            ...
            },
            {
                ...
                ALT: () => {
                    ...
                    this.MANY6(() => {
                        this.OR6([
                            { ALT: () => this.SUBRULE1(this.stereotype) },
                            { ALT: () => this.SUBRULE1(this.colorValue) }
                        ]);
                    });
                    ...
                    this.MANY7({
                        ...
                        DEF: () => {
                            this.OR7([
                                ...
                                { ALT: () => this.SUBRULE1(this.classMember) }
                            ]);
                        }
                    });
            ...
            },
            {
                GATE: () => {
                    ...
                    return this.LA(i).tokenType === Colon;
                },
                ALT: () => {
                    this.SUBRULE4(this.name, { LABEL: "name" });
                    this.CONSUME(Colon);
                    this.SUBRULE2(this.memberLabel, { LABEL: "member" });
                }
            }
        ]);
    });
        ...
        this.OR([
            { 
                ...
                ALT: () => {
                    ...
                    this.OPTION(() => {
                        ...
                        this.SUBRULE(this.nodeIdentifier, { LABEL: "name" });
                    });
                }
            },
            { 
                GATE: () => this.LA(1).tokenType === Quote,
                ALT: () => {
                    this.CONSUME1(Quote, { LABEL: "q1" });
                    this.MANY(() => this.CONSUME2(Identifier, { LABEL: "labelTokens" }));
                    this.CONSUME2(Quote, { LABEL: "q2" });
                    this.OPTION4(() => {
                        this.OPTION5(() => this.CONSUME2(As));
                        this.SUBRULE2(this.nodeIdentifier, { LABEL: "name" });
                    });
                }
            },
            {
                ...
                ALT: () => {
                    this.CONSUME(LParen);
                    this.SUBRULE1(this.name, { ARGS: [inConnection], LABEL: "part1" });
                    this.MANY1(() => {
                        this.CONSUME(Comma);
                        this.SUBRULE2(this.name, { ARGS: [inConnection], LABEL: "parts" });
                    });
                    this.CONSUME(RParen);
                }
            },
            {
                ...
                ALT: () => {
                    this.CONSUME(LBracket);
                    this.OPTION6(() => {
                        this.SUBRULE3(this.nodeIdentifier, { LABEL: "name" });
                        this.CONSUME(RBracket);
                    });
                }
            },
    ...
    public noteType = this.RULE("noteType", () => {
        this.OR([
            { ALT: () => this.CONSUME(Note) },
            { ALT: () => this.CONSUME(Hnote) },
            { ALT: () => this.CONSUME(Rnote) }
        ]);
    });
    ...
    public noteBlock = this.RULE("noteBlock", () => {
        this.MANY({
            GATE: () => {
                const next1 = this.LA(1).tokenType;
                const next2 = this.LA(2).tokenType;
                if (next1 === End && next2 === Note) return false;
                if (next1 === End && next2 === Ref) return false;
                if (next1 === EndNote) return false;
                if (next1 === Endref) return false;
                if (next1 === Endhnote || next1 === Endrnote) return false;
                return true;
            },
            DEF: () => {
                this.OR([
        ...
        this.OR5([
            { 
                ALT: () => {
                    this.CONSUME1(End);
                    this.OR6([
                        { ALT: () => this.CONSUME2(Note) },
                        { ALT: () => this.CONSUME2(Ref) }
                    ]);
                }
            },
            { ALT: () => this.CONSUME(EndNote) },
            { ALT: () => this.CONSUME(Endref) },
            { ALT: () => this.CONSUME(Endhnote) },
            { ALT: () => this.CONSUME(Endrnote) }
        ]);
    });
    ...
    public noteDeclaration = this.RULE("noteDeclaration", () => {
        ...
        this.OR1([
                    ...
                    this.OR([
                        { 
                            ...
                            ALT: () => {
                                this.CONSUME(On);
                                this.OR7([
                                    { ALT: () => this.CONSUME(Arrow, { LABEL: "link" }) },
                                    { ALT: () => this.CONSUME(Identifier, { LABEL: "link" }) }
                                ]);
                            }
                        },
                        { 
                            ALT: () => {
                                this.OPTION1(() => this.CONSUME(Of));
                                this.SUBRULE(this.name, { LABEL: "target" });
                                this.MANY(() => {
                                    this.CONSUME(Comma);
                                    this.SUBRULE1(this.name, { LABEL: "target" });
                                });
                            }
                        }
                    ]);
            ...
            { 
                ALT: () => {
                    this.CONSUME1(On);
                    this.OR8([
                        { ALT: () => this.CONSUME1(Arrow, { LABEL: "link" }) },
                        { ALT: () => this.CONSUME1(Identifier, { LABEL: "link" }) }
                    ]);
                }
            },
            { ALT: () => {
            ...
            {
                GATE: () => this.LA(1).tokenType === StringLiteral || this.LA(1).tokenType === Quote,
                ALT: () => {
                    this.SUBRULE2(this.name, { LABEL: "floatingContent" });
                    this.OPTION3(() => {
                        this.CONSUME(As);
                        this.SUBRULE2(this.nodeIdentifier, { LABEL: "alias" });
                    });
                }
            },
            {
                ...
                ALT: () => {
                    this.CONSUME1(As);
                    this.SUBRULE3(this.nodeIdentifier, { LABEL: "alias" });
                }
            },
            { ALT: () => {} }
        ]);
        ...
        this.OR4([
            ...
            { 
                GATE: () => {
                    const t1 = this.LA(1).tokenType;
                    if (t1 !== Newline) return false;
                    let i = 2;
                    while (true) {
                        const tok = this.LA(i).tokenType;
                        if (tok === EndNote || tok === Endhnote || tok === Endrnote || (tok === End && (this.LA(i+1).tokenType === Note || this.LA(i+1).tokenType === Ref))) return true;
                        if (tok === EndUml || tok === EOF) return false;
                        i++;
                    }
                },
                ALT: () => {
                    this.MANY1(() => this.CONSUME(Newline));
                    this.SUBRULE(this.noteBlock);
                }
            },
            { 
                ALT: () => {} 
    ...
    public refDeclaration = this.RULE("refDeclaration", () => {
        ...
        this.OR4([
            ...
            { 
                GATE: () => this.LA(1).tokenType === Newline,
                ALT: () => {
                    this.MANY1(() => this.CONSUME(Newline));
                    this.SUBRULE(this.noteBlock); 
                }
    ...
    public elseBlock = this.RULE("elseBlock", () => {
        this.CONSUME(Else);
        this.MANY1(() => this.SUBRULE(this.colorValue));
        this.SUBRULE(this.label);
        this.MANY2(() => this.SUBRULE1(this.colorValue));
        this.OPTION1(() => this.SUBRULE(this.payload));
        this.CONSUME(Newline);
        this.MANY({
            GATE: () => {
                const nextType = this.LA(1).tokenType;
                return nextType !== End && nextType !== Else && nextType !== EndUml;
            },
            DEF: () => {
                this.OR1([
                    { ALT: () => this.CONSUME1(Newline) },
    ...
    public groupingBlock = this.RULE("groupingBlock", () => {
        ...
        this.OPTION2(() => {
            this.CONSUME(LBracket);
            this.SUBRULE1(this.label);
            this.CONSUME(RBracket);
        });
        this.MANY3(() => this.SUBRULE2(this.colorValue));
        this.CONSUME(Newline);
        this.MANY({
            GATE: () => {
                const nextType = this.LA(1).tokenType;
        ...
        this.CONSUME(End);
        this.OPTION3(() => this.CONSUME1(Box));
    });

    public activationDeclaration = this.RULE("activationDeclaration", () => {
        this.OR([
            { ALT: () => this.CONSUME(Activate) },
            { ALT: () => this.CONSUME(Deactivate) },
            { ALT: () => this.CONSUME(Destroy) }
        ]);
        this.CONSUME(Identifier);
        this.OPTION(() => this.SUBRULE(this.colorValue));
    });

    public autoactivateStatement = this.RULE("autoactivateStatement", () => {
        this.CONSUME(Autoactivate);
        this.OR([
            { ALT: () => this.CONSUME(On) },
    ...
    public createStatement = this.RULE("createStatement", () => {
        this.CONSUME(Create);
        this.OR([
            { 
                GATE: () => {
                    const next = this.LA(1).tokenType;
                    return next === Participant || next === Actor || next === Boundary || next === Control || next === Entity || next === Database || next === Collections || next === Queue;
                },
    ...
    public mainframeStatement = this.RULE("mainframeStatement", () => {
        this.CONSUME(Mainframe);
        this.SUBRULE(this.label);
    });

    public jsonBlock = this.RULE("jsonBlock", () => {
        this.CONSUME(Json);
        this.SUBRULE(this.name, { LABEL: "name" });
        this.CONSUME(LBrace);
        this.MANY({
    ...
    public styleBlock = this.RULE("styleBlock", () => {
        this.CONSUME(LAngle);
        this.CONSUME(Identifier); // "style"
        this.CONSUME(RAngle);
        this.MANY({
            GATE: () => {
                const t1 = this.LA(1).tokenType;
                ...
                // Stop at </style> or newline followed by </style>
                if (t1 === Slash && t2 === Identifier && t3 === RAngle) return false;
                if (t1 === Newline && t2 === Slash && this.LA(3).tokenType === Identifier) return false;
                return true;
            },
            DEF: () => {
                this.OR([
    ...
    public togetherBlock = this.RULE("togetherBlock", () => {
        this.CONSUME(Together);
        this.CONSUME(LBrace);
        this.MANY(() => {
            this.OR([
                { ALT: () => this.CONSUME(Newline) },
    ...
    public containerBlock = this.RULE("containerBlock", () => {
        this.OR([
            { ALT: () => this.CONSUME(Package) },
        ...
        this.OPTION(() => this.SUBRULE(this.name, { LABEL: "name" }));
        this.MANY(() => {
            this.OR1([
                { ALT: () => {
                    this.CONSUME(As);
        ...
        this.OR2([
            ...
            { ALT: () => {
                this.SUBRULE(this.multilineLabel);
            }}
        ]);
    });
    ...
    public ignoredStatement = this.RULE("ignoredStatement", () => {
        this.OR([
            { ALT: () => this.CONSUME(Skinparam) },
            { ALT: () => this.CONSUME(Hide) },
            ...
            { ALT: () => this.CONSUME(Delay) },
            { ALT: () => this.CONSUME(VerticalBar) },
            { ALT: () => this.CONSUME(Allowmixing) },
            { ALT: () => this.SUBRULE(this.styleBlock) },
            { ALT: () => this.CONSUME(Empty) },
            {
                ALT: () => {
                    this.CONSUME(Scale);
                    this.MANY3(() => this.SUBRULE3(this.anyToken));
                }
            },
            {
                ALT: () => {
                    this.CONSUME(Page);
                    this.MANY7(() => this.SUBRULE7(this.anyToken));
                }
            },
            {
                ALT: () => {
                    ...
                    this.CONSUME(To);
                    this.OR5([
                        { ALT: () => this.CONSUME1(Left) },
                        { ALT: () => this.CONSUME1(Right) },
                        { ALT: () => this.CONSUME1(Top) },
                        { ALT: () => this.CONSUME1(Bottom) }
                    ]);
            ...
            },
            {
                ALT: () => {
                    this.CONSUME(Set);
                    this.MANY4(() => this.SUBRULE4(this.anyToken));
                }
            }
        ]);
        ...
        this.MANY({
            GATE: () => {
                const nextType = this.LA(1).tokenType;
                return nextType !== Newline && nextType !== EndUml && nextType !== LBrace;
            },
            DEF: () => this.SUBRULE(this.anyToken)
        });
        this.OR1([
            ...
            {
                GATE: () => isTitle && this.LA(1).tokenType === Newline,
                ALT: () => {
                    ...
                    this.MANY2({
                        GATE: () => {
                            const t1 = this.LA(1).tokenType;
                            const t2 = this.LA(2).tokenType;
                            return !(t1 === End && t2 === Title) && t1 !== EndUml;
                        },
                        DEF: () => {
                            this.OR3([
                                {
                                    GATE: () => {
                                        const t1 = this.LA(1).tokenType;
                                        const t2 = this.LA(2).tokenType;
                                        return !(t1 === End && t2 === Title);
                                    },
                                    ALT: () => this.SUBRULE2(this.anyToken)
                                },
                                { ALT: () => this.CONSUME2(Newline) }
                            ]);
                        }
    ...
    public statement = this.RULE("statement", () => {
        ...
        this.OR([
            ...
            { 
                GATE: () => {
                    const t1 = this.LA(1).tokenType;
                    const isNote = t1 === Note || t1 === Hnote || t1 === Rnote;
                    if (!isNote) return false;
                    const t2 = this.LA(2).tokenType;
                    return t2 === Left || t2 === Right || t2 === Top || t2 === Bottom || t2 === Over || t2 === Across || t2 === Color || t2 === Newline || t2 === Colon || t2 === StringLiteral || t2 === Quote || t2 === As || t2 === On || t2 === Identifier;
                },
            ...
            { 
                GATE: () => {
                    const t1 = this.LA(1).tokenType;
                    if (t1 !== Ref) return false;
                    const t2 = this.LA(2).tokenType;
                    return t2 === Over || t2 === Newline || t2 === Colon;
                },
            ...
            { 
                GATE: () => {
                    const next = this.LA(1).tokenType;
                    const isParticipantKeyword = 
                        next === Participant || next === Actor || next === Boundary || 
                        next === Control || next === Entity || next === Database || 
                        next === Collections || next === Queue || next === Artifact ||
                        next === Storage || next === Rectangle || next === Card ||
                        next === FileKeyword || next === Stack || next === Hexagon ||
                        next === Person || next === Process || next === Agent ||
                        next === LabelKeyword || next === Usecase || next === Component ||
                        next === Action || next === MapKeyword || next === State ||
                        next === Class || next === Interface || next === Enum ||
                        next === Struct || next === Annotation || next === Abstract ||
                        next === Circle || next === Diamond || next === Exception ||
                        next === Metaclass || next === Protocol || next === Record ||
                        next === Dataclass || next === ObjectKeyword ||
                        next === Port || next === PortIn ||
                        next === PortOut || next === NodeKeyword || 
                        next === Cloud || next === Frame ||
                        next === Folder || next === Package;
                    
                    if (!isParticipantKeyword) return false;
            ...
            { 
                GATE: () => {
                    const next = this.LA(1).tokenType;
                    return next === Activate || next === Deactivate || next === Destroy;
                },
                ALT: () => this.SUBRULE(this.activationDeclaration) 
            },
            { 
                GATE: () => this.LA(1).tokenType === Autoactivate,
            ...
            { 
                GATE: () => this.LA(1).tokenType === Create,
                ALT: () => this.SUBRULE(this.createStatement) 
            },
            { 
                GATE: () => {
                    const t1 = this.LA(1).tokenType;
                    return t1 === Package || t1 === Namespace || t1 === Folder || t1 === Cloud || t1 === Frame || t1 === Rect || t1 === NodeKeyword || t1 === Artifact || t1 === Storage || t1 === Rectangle || t1 === Card || t1 === FileKeyword || t1 === Stack || t1 === Hexagon || t1 === Person || t1 === Process || t1 === Agent || t1 === LabelKeyword || t1 === Usecase || t1 === Component || t1 === Action || t1 === MapKeyword || t1 === Database || t1 === Queue || t1 === Boundary || t1 === Control || t1 === Entity || t1 === Collections;
                },
                ALT: () => this.SUBRULE(this.containerBlock) 
            },
            { 
                GATE: () => this.LA(1).tokenType === Json,
                ALT: () => this.SUBRULE(this.jsonBlock) 
            },
            { 
                GATE: () => this.LA(1).tokenType === Together,
                ALT: () => this.SUBRULE(this.togetherBlock) 
            },
            { 
                GATE: () => this.LA(1).tokenType === Mainframe,
                ALT: () => this.SUBRULE(this.mainframeStatement) 
            },
            { 
                GATE: () => {
                    const t1 = this.LA(1).tokenType;
                    return t1 === Skinparam || t1 === Hide || t1 === Show || t1 === Remove || t1 === Restore || t1 === Empty || t1 === Autonumber || t1 === Newpage || t1 === Ignore || t1 === Header || t1 === Footer || t1 === Title || t1 === Exclamation || t1 === Divider || t1 === Slash || t1 === Delay || t1 === VerticalBar || t1 === Allowmixing || t1 === LAngle
